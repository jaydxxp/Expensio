...
export default function Logbar() {
  ...
  <div className="w-full p-3 sm:p-6">
    <div className="flex items-center justify-between gap-2 w-full">
      ...
      <div className="flex flex-nowrap items-center justify-end gap-2 sm:gap-5 min-w-0 flex-1">
        <Link to={"/dashboard"}>
          <button className="font-semibold text-xs sm:text-base text-white hover:text-gray-300 transition duration-200 whitespace-nowrap">
            Dashboard
          </button>
        </Link>
        ...
        <button
          ...
          className="flex items-center gap-1 sm:gap-2 bg-[#1e1e1e] border border-[#282828] rounded-lg px-2 sm:px-3 py-1 sm:py-1.5 text-white text-xs sm:text-base font-medium hover:bg-[#282828] transition whitespace-nowrap"
        >
        ...
        <button
          ...
          className="px-2 sm:px-5 py-1 sm:py-2 rounded-full font-semibold text-xs sm:text-base bg-[#171717] border border-[#282828] text-white focus:ring-2 focus:ring-gray-500 hover:shadow-xl hover:scale-105 transition-all duration-200 whitespace-nowrap"
        >
          Logout
        </button>
      </div>
