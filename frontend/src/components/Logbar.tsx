...
export default function Logbar() {
  ...
  return (
   <div className="w-full p-3 sm:p-6 flex items-center justify-between gap-2 sm:gap-6">
  ...
  <div className="flex items-center justify-between w-full gap-2">
    ...
    <div className="flex flex-nowrap items-center justify-end gap-2 sm:gap-5 overflow-x-auto no-scrollbar min-w-0 flex-1 px-2 sm:px-0">
      <Link to={"/dashboard"}>
