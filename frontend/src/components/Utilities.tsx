    ...
    <div className="fixed bottom-5 right-5 flex items-center z-50">
      <div className="flex items-center space-x-3 mr-3">
        ...
        >
          ...
          >
            <svg
              fill={activeWidget === "ai" ? "#000000" : "#ffffff"}
              width="40"
              height="40"
      ...
      >
        <span className="text-xl font-bold">
          {open ? (
            ...
            >
              <path
                d="m43.5,14.87c.0221-1.0104-.7791-1.8475-1.7895-1.8696-.0102-.0002-.0203-.0004-.0305-.0004h-16.91c-2-.1-5.93-4.23-8.19-4.23H6.68c-1.204-.0003-2.1803.9754-2.1806,2.1794,0,.0169.0002.0337.0006.0506h0v26c-.0111,1.2039.956,2.1889,2.1599,2.1999.0034,0,.0067,0,.0101,0h34.65c1.204,0,2.18-.9759,2.1801-2.1799,0-.0067,0-.0134,0-.0201h0V14.87Z"
                fill="none"
                stroke="#ffffff"
                strokeWidth={2}
                strokeLinecap="round"
              ...
              />
              <path
                d="m24.4076,22.7396l1.0292,2.2456,2.2457,1.0295c.2251.1032.3239.3694.2207.5945-.0448.0976-.1231.1759-.2207.2207l-2.2457,1.0291-1.0292,2.2457c-.1031.2251-.3692.3239-.5943.2208-.0977-.0448-.176-.1231-.2208-.2208l-1.0291-2.246h0s-2.2457-1.0292-2.2457-1.0292c-.2251-.1031-.3239-.3692-.2208-.5943.0448-.0977.1231-.176.2208-.2208l2.2457-1.0292,1.0291-2.2456c.1031-.2251.3692-.3239.5943-.2208.0977.0448.176.1231.2208.2208Z"
                fill="none"
                stroke="#ffffff"
                strokeWidth={2}
                strokeLinecap="round"
